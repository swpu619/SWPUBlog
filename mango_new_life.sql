...
DROP DATABASE IF EXISTS `mango_new_life`;
CREATE DATABASE `mango_new_life`;
...
CREATE TABLE `mango_comment` (
  ...
  `comment_creat_time` DATETIME NOT NULL DEFAULT '2022-08-16 16:54:23',
...
CREATE TABLE `mango_comment_reply` (
  ...
  `reply_time` DATETIME NOT NULL DEFAULT '2022-08-16 16:54:23',
...
CREATE TABLE `mango_message` (
  ...
  `message_creat_time` DATETIME NOT NULL DEFAULT '2022-08-16 16:54:23',
...
CREATE TABLE `mango_new_message` (
  `new_message_time` DATETIME NOT NULL DEFAULT '2022-08-16 16:54:23',
...
CREATE TABLE `mango_shop` (
  ...
  `shop_creat_time` DATETIME NOT NULL DEFAULT '2019-08-16 16:54:23',
  PRIMARY KEY (`shop_id`)
...
CREATE TABLE `mango_user` (
  ...
  `user_creat_time` DATETIME NOT NULL DEFAULT '2021-08-16 16:54:23',
  PRIMARY KEY (`user_id`)
